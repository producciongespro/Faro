...
<div className="row">
      <div className="col-1">
        <img className="btn"  src={ images[0].HomeVolver } data-tar="Portada"  onClick={this.props.changePage} alt="Volver a Portada" />
      </div>
      ...
      <div className="col-1">
        <img className="btn" src={ images[0].HomeSonido } alt="Sonido" />
        <img className="btn" src={ images[0].HomeCaja } alt="Caja herramientas" />
      </div>
    </div>
