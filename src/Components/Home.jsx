...
const Home = (props) => {
  return ( 
    ...
    <img className="btn img-fluid hvr-pop acercade" id="acercade" src={ img + "acercade.png" } onClick = {props.showModal }  data-typecontent ="acercaDe" data-content= {textos.IndicacionesPortada}  alt="Indicaciones" /> <br/>
