...
const Home = (props) => {
  return ( 
    ...
    <img className="btn img-fluid hvr-pop" id="acercade" src={ img + "acercade.png" } onClick = {props.showModal }  data-typecontent ="help" data-content= {textos.IndicacionesPortada}  alt="Indicaciones" /> <br/>
