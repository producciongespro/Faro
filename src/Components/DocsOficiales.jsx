    ...
    <div className="row">
      ...
      <div className="col-8" >
        ...
        <div className="botones_salir col-12">
          <img data-tar="Home" onClick={props.changePage} onKeyPress={props.changePage} className="derecha btn img-fluid hvr-pop" src={imgGenerales + "btn_salir.png"} alt="regresar a portada" />
        </div>
          ...
          <div className="col-3">
            <figure>
              <img
                tabIndex="2"
                role="button"
                title="ir a políticas educativas"
