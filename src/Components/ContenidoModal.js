            ...
            html = (
                <div className="row">
                    <div className="col-sm-3">
                        <a tabIndex="1" title="Guía televisiva" href="https://recursos.mep.go.cr/2020/aprendoencasa/" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="col-sm-3">
                        <a tabIndex="1" title="Guías de trabajo autonómo" href="https://aulavirtualabierta.mep.go.cr/curso/" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="col-sm-3">
                        <a tabIndex="1" title="Plantillas de aprendizaje" href="http://www.ddc.mep.go.cr/estrategia-covid19/plantillas-aprendizajes-base-2020" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="col-sm-3">
                        <a tabIndex="1" title="Fiestas patrias" href="https://cajadeherramientas.mep.go.cr/faro_referencias/1_ref_portada/GTA_FIESTAS_PATRIAS.zip" target="_blank" rel="noopener noreferrer">
