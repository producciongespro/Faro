...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 03, 2020 at 07:38 PM
...
CREATE TABLE IF NOT EXISTS `bitacora` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=105 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabla para documentar eventos de los usuarios en el sistema';
...
(92, '108', 'Agregar', '2020-03-30 14:58:31', 59, 'Recursos'),
(93, '108', 'Agregar', '2020-03-30 15:01:06', 60, 'Recursos'),
(94, '108', 'Agregar', '2020-03-30 15:03:39', 61, 'Recursos'),
(95, '108', 'Agregar', '2020-03-30 15:06:02', 62, 'Recursos'),
(104, '106', 'Agregar', '2020-04-03 18:34:27', 63, 'Oferta Desarrollo'),
(100, '106', 'Elimina', '2020-04-03 15:10:35', 3, 'desarrollo_profesional'),
(101, '106', 'Elimina', '2020-04-03 15:12:55', 4, 'desarrollo_profesional'),
(102, '106', 'Elimina', '2020-04-03 15:36:08', 1, 'desarrollo_profesional'),
(103, '106', 'Elimina', '2020-04-03 15:53:04', 2, 'desarrollo_profesional');

-- --------------------------------------------------------

--
-- Table structure for table `desarrollo_profesional`
--

DROP TABLE IF EXISTS `desarrollo_profesional`;
CREATE TABLE IF NOT EXISTS `desarrollo_profesional` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(79723, 170378, 152809, 125265, 71617, 355356);

-- --------------------------------------------------------

--
-- Table structure for table `estadisticasold`
--

DROP TABLE IF EXISTS `estadisticasold`;
CREATE TABLE IF NOT EXISTS `estadisticasold` (
  `clim` int(255) NOT NULL,
  `eval` int(255) NOT NULL,
  `recu` int(255) NOT NULL,
  `docu` int(255) NOT NULL,
...
--
-- Dumping data for table `estadisticasold`
--
...
(59, 'E-mentores', 'E-mentores es un espacio de autoformación  en línea para la prevención y respuesta del abuso y explotación sexual en línea. Bajo el enfoque de ciudadanía digital, a través de recursos audiovisuales interactivos las personas con roles de cuido y acompañamiento aprenden a guiar y acompañar a las personas menores de edad en sus interacciones en línea para promover un uso seguro y responsable de las TIC.', 3, 'Sétimo,Octavo,Noveno,Décimo,Undécimo', 'https://www.mep.go.cr/educatico/e-mentores', 'Educación Cívica ', 'https://www.mep.go.cr/sites/default/files/imagecache/recurso_educativo_nodo/ementores.jpg', 0, 108, '2020-03-30 14:58:31', 0),
(60, 'El Arte de la Industria', 'El Arte de la Industria', 2, 'Primero,Segundo,Tercero,Cuarto,Quinto,Sexto', 'https://www.mep.go.cr/educatico/arte-industria', 'Artes Industriales', 'https://www.mep.go.cr/sites/default/files/imagecache/recurso_educativo_nodo/arte_industria.jpg', 0, 108, '2020-03-30 15:01:06', 0),
(61, 'Biotecnología: cultivos celulares y reproducción asistida', 'La profesora Sary Arroyo Gutiérrez nos explica el tema de biotecnología, células madre totimultipotenciales que tienen la capacidad de  diferenciarse en otros tipos celulares, crecer, dividirse y diferenciarse para dar lugar a un organismo completo.  Descripción de la técnica de cultivo celular. ', 4, 'vacio', 'https://www.mep.go.cr/educatico/biotecnologia-cultivos-celulares-reproduccion-asistida', 'N/A', 'https://www.mep.go.cr/sites/default/files/imagecache/recurso_educativo_nodo/biotecnologia.png', 0, 108, '2020-03-30 15:03:39', 0),
(62, 'Recursos visuales Ministerio de Salud Costa Rica', 'Repositorio donde se encuentran los diferentes afiches informativos en torno a la prevención del COVID-19.', 3, 'Sétimo,Octavo,Noveno,Décimo,Undécimo,Duodécimo', 'https://www.mep.go.cr/educatico/recursos-visuales-ministerio-salud-costa-rica', '-1', 'https://www.mep.go.cr/sites/default/files/imagecache/recurso_educativo_nodo/repositorio-ms.png', 0, 108, '2020-03-30 15:06:02', 0),
(63, 'Orientaciones contextuales  Subsistema en Educación Indígena', 'Es un documento que brinda información sobre la cultura Cabecar de Alto Chirripo y a la vez se orienta en un abordaje desde la perspectiva de la legislacion educativa indigena.', 4, 'vacio', 'https://www.mep.go.cr/educatico/orientaciones-educacion-indigena', 'N/A', 'https://www.mep.go.cr/sites/default/files/imagecache/recurso_educativo_nodo/orientaciones_educ_indigena.png', 0, 109, '2020-03-30 16:33:01', 0);
...
--
-- Table structure for table `sub_categorias_idp`
--

DROP TABLE IF EXISTS `sub_categorias_idp`;
CREATE TABLE IF NOT EXISTS `sub_categorias_idp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sub_categorias_idp`
--
...
--
-- Table structure for table `tipos_odp`
--

DROP TABLE IF EXISTS `tipos_odp`;
CREATE TABLE IF NOT EXISTS `tipos_odp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `tipos_odp`
--
...
(106, 'luis@correo.de', '$2y$10$FRcsor4X9UHLiUjQ3BqSZe0vnWF/lSH79tLM1kqHSfLcHr8CfY27i', 'Luis', 'Chacón', 'Campos', 'GESPRO', NULL, '300b97290992f470ea62e0e7fe3222c8', NULL, 0, 2, 1),
