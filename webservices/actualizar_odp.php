...
if (isset ($dataObject-> id_sub_categoria)) {
   ...
   $actualizacion = "UPDATE `desarrollo_profesional` SET `nombre`= '$nombre',`descripcion`='$descripcion',`poblacion`='$poblacion',`url`='$url',`id_tipo`='$id_tipo',`id_usuario`='$id_usuario',`url_imagen`='$url_imagen',`id_sub_categoria`='$id_sub_categoria' WHERE `id`='$id'";
