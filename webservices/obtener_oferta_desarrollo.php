...
$sql= "SELECT desarrollo_profesional.id, desarrollo_profesional.nombre, desarrollo_profesional.descripcion, desarrollo_profesional.poblacion, desarrollo_profesional.url, desarrollo_profesional.url_imagen,desarrollo_profesional.id_tipo, tipos_odp.oferta,desarrollo_profesional.id_sub_categoria, sub_categorias_idp.nombreCategoria  FROM `desarrollo_profesional` LEFT JOIN `sub_categorias_idp` ON desarrollo_profesional.id_sub_categoria=sub_categorias_idp.id LEFT JOIN `tipos_odp` ON tipos_odp.id=desarrollo_profesional.id_tipo WHERE desarrollo_profesional.borrado = 0 ORDER BY desarrollo_profesional.id";
